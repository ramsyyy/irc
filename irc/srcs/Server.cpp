...
int    Server::cap(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) {
    (void)event;
	(void)rc;
	(void)num_event;
...
int    Server::user(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) {
    (void)event;
	(void)rc;
	(void)num_event;
...
int    Server::privMsg(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) {
	(void)event;
	(void)rc;
	(void)num_event;
	std::string response;
...
int    Server::notice(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) {
	(void)event;
	(void)rc;
	(void)num_event;
	std::string response;
...
int    Server::ping(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) {
	std::string response;
	(void)cmd;
	(void)event;
	(void)rc;
...
int    Server::pong(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) {
	(void)cmd;
	(void)event;
	(void)rc;
	(void)num_event;
...
int    Server::whois(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) {
	std::string response;
	(void)event;
	(void)rc;
	(void)num_event;
...
int  Server::part(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) {
    (void)event;
	(void)rc;
	(void)num_event;
...
int    Server::join(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) {
    (void)event;
	(void)rc;
	(void)num_event;
	std::string channel = cmd.getParameters()[0].c_str() + 1;
...
int    Server::oper(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) 
{
	(void)event;
	(void)rc;
	(void)num_event;
...
int    Server::mode(Command cmd, User *user, struct epoll_event event, int rc, int *num_event)
{
	(void)event;
	(void)rc;
	(void)num_event;
...
int  Server::invite(Command cmd, User *user, struct epoll_event event, int rc, int *num_event) 
{
	(void)event;
	(void)rc;
	(void)num_event;
...
int  Server::kill(Command cmd, User *user, struct epoll_event event, int rc, int *num_event)
{
	(void)event;
	(void)rc;
	(void)num_event;
...
int	Server::executee_cmd(Command cmd, User *user, struct epoll_event event, int rc, int *num_event)
{
	...
	for (int i = 0; i < 16; i++)
	{
		...
		//std::cout << cmd.getName() << " " << (*user)->getUsername() << std::endl;
			if ((user) == NULL) 
				break ;	
			return ((this->*ptr_fct[i])(cmd, user, event, rc, num_event));
		}
	}
...
int	Server::execute_cmd(Command cmd, User *user, struct epoll_event event, int rc, int *num_event)
{
	...
	int i = executee_cmd(cmd, user, event, rc, num_event);
	return (i);
...
// 			std::map<std::string, Channel *>::iterator itt = channels.find(channel);
// 			if (it != _users.end())
// 				other = it-cmd.cmds.find(cmd.getName())->second>second;
// 			if (itt == channels.end())
// 			{
// 				reply(-1, ERR_NOSUCHCHANNEL, user, &cmd, *this, NULL);
// 				break ;
